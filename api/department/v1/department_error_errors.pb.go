...
func IsDepartmentNotFound(err error) bool {
	...
	return e.Reason == ErrorReason_DEPARTMENT_NOT_FOUND.String() && e.Code == 404
}

func ErrorDepartmentNotFound(format string, args ...interface{}) *errors.Error {
	return errors.New(404, ErrorReason_DEPARTMENT_NOT_FOUND.String(), fmt.Sprintf(format, args...))
}
